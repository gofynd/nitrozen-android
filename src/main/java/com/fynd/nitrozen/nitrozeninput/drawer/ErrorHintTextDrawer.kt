...
internal class ErrorHintTextDrawer(val view: NInput, val input: NitrozenInput) :
    Drawer<NInput, NitrozenInput>(view, input) {

    private var errorText: TextView = TextView(view.context)
    ...
    override fun isReady(): Boolean {
        return !TextUtils.isEmpty(input.errorText) && input.showError
    }
